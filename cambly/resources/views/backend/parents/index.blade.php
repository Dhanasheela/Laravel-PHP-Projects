...
<div class="roles-permissions">
    ...
    <table id="example" class="mt-8 bg-white rounded border-b-4 border-gray-300">
        <thead>
            <tr class="flex flex-wrap items-center uppercase text-sm font-semibold bg-gray-300 text-gray-600 rounded-tl rounded-tr">
                ...
                <th class="w-1/12 px-4 py-3">Email</th>
                <th class="w-2/12 px-4 py-3">Children</th>
                <th class="w-1/12 px-4 py-3">Phone</th>
        ...
        <tbody>
            ...
            <tr class="flex flex-wrap items-center text-gray-700 border-t-2 border-l-4 border-r-4 border-gray-300">
                <td class="w-2/12 px-4 py-3 text-sm font-semibold text-gray-600 tracking-tight">{{ $parent->user->name }}</td>
                <td class="w-2/12 px-4 py-3 text-sm font-semibold text-gray-600 tracking-tight">{{ $parent->user->email }}</td>
                <td class="w-2/12 px-4 py-3 text-sm font-semibold text-gray-600 tracking-tight">
                ...
                <td class="w-1/12 px-4 py-3 text-sm font-semibold text-gray-600 tracking-tight">{{ $parent->phone }}</td>
