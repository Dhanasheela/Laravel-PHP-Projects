...
Route::group(['middleware' => ['auth', 'role:Admin']], function () {
    ...
    Route::get('exam/schedule', [ExamController::class, 'index1']);
    Route::get('exam/create', [ExamController::class, 'create']);
    Route::get('exam/marks', [ExamController::class, 'create1']);
    Route::get('exam/entry/{id}', [ExamController::class, 'entry']);
    Route::post('exam/store1', [ExamController::class, 'store1']);
